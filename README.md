...
**[Wordle Solver](https://github.com/vidit-16/WordleSolver)** — constraint satisfaction against information theory on the same board, benchmarked head to head on all 2,315 official answers: information gain loses 5 games where constraint search loses 22, and pays for it with 13x the time per game · [live](https://wordle--solver.streamlit.app/)

**[Food Vision](https://github.com/vidit-16/foodVision)** — a ConvNeXt-Tiny classifier fine-tuned on Food-101 and served through FastAPI; changing the backbone and the training recipe took top-1 accuracy from 82.2% to 91.9% on the official test split
